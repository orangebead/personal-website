...
const YOUR_EMAIL = "neil011205@gmail.com"
const YOUR_GITHUB = "https://github.com/orangebead"
const YOUR_LINKEDIN = "https://www.linkedin.com/in/neillaturkar/"
  ...
  return (
    <div className="fixed bottom-10 left-0 right-0 flex flex-col items-center z-50">
      <Dock direction="middle" iconSize={56} iconMagnification={80}>
        ...
        <DockIcon
          onClick={() => window.open(YOUR_GITHUB, "_blank")}
        ...
        <DockIcon
          onClick={() => window.open(YOUR_LINKEDIN, "_blank")}
        ...
        <DockIcon
          ...
          onMouseEnter={() => setTooltip("Copy Email")}
          onMouseLeave={() => setTooltip(null)}
        >
