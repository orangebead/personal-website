...
export function DockDemo() {
  ...
  <div className="fixed bottom-10 left-0 right-0 flex flex-col items-center z-50">
    <Dock direction="middle" iconSize={56} iconMagnification={80}>
      <DockIcon onClick={() => window.open(YOUR_GITHUB, "_blank")}>
        <Icons.gitHub className="size-7" />
      </DockIcon>
      <DockIcon onClick={() => window.open(YOUR_LINKEDIN, "_blank")}>
    ...
    {copied && (
      <span className="absolute -bottom-6 text-m text-muted-foreground">
        Email copied!
      </span>
    )}
  </div>
